...
class DepositReqController extends Controller
{
    public function index(Request $request)
    {
        ...
        $filter_application_category = $request->input('sReqDvsCode', '');
        ...
        $sql = DepositReq::when($filter_application_category != '', function($query) use ($filter_application_category) {
                $query->where('application_category', "%$filter_application_category%");
        ...
        // dd($page_number);
        return view('admin.member.deposit_req', [
            'list' => $list,
            ...
            'filter_application_category' => $filter_application_category,
