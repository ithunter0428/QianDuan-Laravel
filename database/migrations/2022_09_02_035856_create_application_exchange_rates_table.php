...
class CreateApplicationExchangeRatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('application_exchange_rates', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('application_exchange_rates');
    }
}
