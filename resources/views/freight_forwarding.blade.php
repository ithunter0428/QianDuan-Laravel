...
<td><table width="100%" border="0" cellpadding="3" cellspacing="0">
  <tr>
    <td colspan="2"><table width="100%" border="0">
      <tr>
        ...
        <td><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" bgcolor="#E5E5E5">
          <tr>
            <td align="center">复制订单</td>
          </tr>
        </table></td>
        <td><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" bgcolor="#E5E5E5">
          <tr>
            <td align="center">导入库存</td>
          </tr>
        </table></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0">
            ...
            <tr>
              <td colspan="2"><input name="textfield22" type="text" value="订单编号" size="50"></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
            <tr>
              <td><input name="textfield223" type="text" value="通关类目" size="50"></td>
    ...
    <td><table width="100%" border="0">
      ...
      <tr>
        <td><input name="textfield222" type="text" value="TRANKING NO" size="50"></td>
      </tr>
      <tr>
        <td>没有TRANKING NO请在我的主页申请</td>
      </tr>
      <tr>
  ...
  <tr>
    <td><input name="textfield3322" type="text" value="详细地址">
      <input name="textfield333" type="text" value="地址"></td>
  </tr>
  <tr>
...
<td><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" bgcolor="#F2F2F2">
  <tr>
    <td height="40" align="center" bgcolor="#0000FF"><a style="width:100%" href="/">现在申请</a></td>
  </tr>
</table></td>
</tr>
</table>
