				...
				<form name="frmList" id="frmList" method="post">
					...
					<table border="1">
						...
						<tbody>
							...
							<tr>
								<td class="ntc alCenter"><span class="bold"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{ $announcement['id'] }}</font></font></span></td>
								<td class="ntc alLeft padL1 vm_box">
									<a href="javascript:" onclick="fnView_S(`{{ json_encode(array($announcement)) }}`);" class="Black">
										<font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{ $announcement['title'] }}</font></font>
									</a>
								</td>
								<td class="ntc alCenter">
									<span class="bold"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{ $announcement['creator'] }}</font></font></span>
								</td>
								<td class="ntc alCenter"><span class=""><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{ $announcement['view_count'] }}</font></font></span></td>
								<td class="ntc alCenter"><span class="grey1"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{ $announcement['created_at'] }}</font></font></span></td>
							</tr>
							@endforeach
						</tbody>
					</table>
