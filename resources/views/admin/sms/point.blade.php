...
@section('pageScripts')
<script type="text/javascript" src="{{ asset('/admin_files/sms/SmsPoint_L.js') }}"></script>
@endsection
...
<div id="mid-col">
	<div class="box">
		<div class="nTitle">
			<h2><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">积分明细</font></font></h2>
			<h4 class="white corners"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">短信管理 &gt; 积分记录</font></font></h4>
		</div>
		...
		<div class="box-container corners02"><!-- Begin 검색 폼 -->
			...
			<div class="search-board"> 
				...
				<form name="frmSearch" id="frmSearch" method="get">
					...
					<input type="hidden" name="gMnu2" id="gMnu2" value="10704">
				...
				<form name="frmList" id="frmList" method="post">
					...
					<table border="1">
						...
						<tbody><tr> 
							...
							<th><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">充值积分</font></font></th> 
