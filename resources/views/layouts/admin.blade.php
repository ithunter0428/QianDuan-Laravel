                ...
                <ul id="menu">
                    ...
                    <li class="{{ strrpos(Request::url(), "/admin/member") ? 'select' : '' }}">
                        ...
                        <ul class="deth2">
                            ...
                            <li class="{{ strrpos(Request::url(), "/admin/member/deposit_application/list") ? 'select2' : ''}}"><a href="{{ route("admin.member.deposit_application.home") }}" target="_self"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">存款申请详情</font></font></a></li>
                            <li class="{{ strrpos(Request::url(), "/admin/member/deposit_application/usage") ? 'select2' : ''}}"><a href="{{ route("admin.member.deposit_application.usage") }}" target="_self"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">存款使用记录</font></font></a></li>
                            <li class="{{ strrpos(Request::url(), "/admin/member/deposit_application/without_passbook") ? 'select2' : ''}}"><a href="{{ route("admin.member.deposit_application.without_passbook") }}" target="_self"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">无存折自动支票</font></font></a></li>
                            <li class="{{ strrpos(Request::url(), "/admin/member/notification") ? 'select2' : ''}}"><a href="{{ route("admin.member.notification.home") }}" target="_self"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">通知消息</font></font></a></li>
                            <li class="{{ strrpos(Request::url(), "/admin/member/reg") ? 'select2' : ''}}"><a href="{{ route("admin.member.reg.home") }}" target="_self"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">会员注册管理</font></font></a></li>
                        </ul>
                    </li>
